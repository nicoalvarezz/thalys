...
public enum HttpStatus {
    ...
    PERMANENT_REDIRECT(308, "Permanent Redirect", Category.REDIRECTION),
    ...
    URI_TOO_LONG(414, "URI Too Large", Category.CLIENT_ERROR),
    ...
    INSUFFICIENT_STORAGE(507, "Insufficient Storage", Category.SERVER_ERROR),
    LOOP_DETECTED(508, "Loop Detected", Category.SERVER_ERROR),
    NOT_EXTENDED(510, "Not Extended", Category.SERVER_ERROR),
